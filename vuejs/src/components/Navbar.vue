<template>
  <header>
    <nav
      class="fixed top-0 w-full bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800"
    >
      <div class="flex flex-wrap justify-between items-center">
        <div class="flex justify-start items-center">
          <a routerLink="/" class="flex mr-4">
            <img
              class="w-8 h-8 mr-2"
              src="../assets/ecommerce-shop-transaction-svgrepo-com.svg"
              alt="logo"
            />
            <span
        ...
        <div class="flex items-center lg:order-2">
          ...
          <button
            ...
            type="button"
            @click="logout()"
            class="ml-2 hidden sm:inline-flex items-center justify-center text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-xs px-3 py-1.5 mr-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800"
          >
            logout
          </button>
          <!-- Dropdown menu -->
